...
alex: That's a really interesting question. Ownership versus stewardship enabled by technology. Something definitely worth thinking about as these kinds of records become more common.`,
  displayTranscript: `<p><strong>Alex:</strong> You know, the way we think about our pets—dogs, cats, even horses—it's really shifted, hasn't it? They're not just animals in the house anymore. They're… well, they're family.</p>
...
<p><strong>Jamie:</strong> A legacy keeper. I like that. And their whole mission seems to boil down to this phrase: "Let no animal story be lost."</p>
...
<p><strong>Jamie:</strong> Exactly. And one feature that really stood out was the sharing via LiveLinks. You can share info as a static PDF, sure, but the live link is dynamic—it can be updated in real time. So let's say you have a horse. The farrier can access the horse's profile through a live link, and they can immediately add notes right there: how the horse behaved, what kind of shoes worked, maybe a sensitivity they noticed.</p>
...
<p><strong>Jamie:</strong> And then there's the resume builder feature, which sounds a bit funny—a resume for a pet—but it's actually very practical. It's designed to document things like training certificates, obedience classes, competitions. Rental screenings are a perfect example—landlords often want proof of training or temperament.</p>
...
<p><strong>Jamie:</strong> Now, you mentioned earlier this isn't just for dogs and cats. The documentation talked about horses, right?</p>

<p><strong>Alex:</strong> Yes, absolutely. The system seems particularly well-suited for animals like horses and also other long-lived companions. Horses tend to change hands more frequently—sales, training barns, different riders—and their care is incredibly complex. The platform aims to ensure their voice travels with them, capturing those vital details that might otherwise get lost.</p>

<p><strong>Jamie:</strong> Like what specifically?</p>

<p><strong>Alex:</strong> Things like what triggers founder in this particular horse, or maybe details about an old injury—how it happened, say during barrel racing—or even just knowing which side they're sensitive on for grooming. Losing that kind of information isn't just inconvenient—it could be dangerous.</p>

<p><strong>Jamie:</strong> And you mentioned long-lived pets too.</p>

<p><strong>Alex:</strong> Yeah. Think about parrots. Some species can live 80 years, even longer. That pet might easily outlive its first owner, maybe even the second or third. Their history needs to be transferable across decades. A physical file box just isn't gonna cut it over that kind of time span.</p>

<p><strong>Jamie:</strong> So a system that stores detailed info securely for years—even if the account is dormant for a while—becomes essential. It ensures the next caregiver, whenever they come along, gets the full story: the personality, the health quirks, everything.</p>

<p><strong>Alex:</strong> The knowledge is preserved, not lost to time or circumstance. And to make recording all this easier and maybe a bit more personal, they included ways to handle documents easily—upload files, take a picture of a vet bill or a bag of special food, and it converts it into a viewable stored file.</p>

<p><strong>Jamie:</strong> And then there's this Story Stream. It's like a journal or timeline alongside the usual photo gallery where owners can add notes, milestones, little memories—adds that human touch to the data.</p>
